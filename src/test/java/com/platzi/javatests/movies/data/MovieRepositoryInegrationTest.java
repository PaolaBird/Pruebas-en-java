...
public class MovieRepositoryInegrationTest {
    ...
    public void insert_a_movie() {
        Movie movie = new Movie("Orgullo y prejuicio", 140, Genre.ROMANCE, "Jane Austen");
        movieRepository.saveOrUpdate(movie);

        Movie movieExpected = movieRepository.findById(4);
        assertThat(movieExpected, is(new Movie(4, "Orgullo y prejuicio", 140, Genre.ROMANCE, "Jane Austen")));
